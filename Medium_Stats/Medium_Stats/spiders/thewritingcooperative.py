...
class ThewritingcooperativeSpider(scrapy.Spider):
    name = 'thewritingcooperative'
    allowed_domains = ['writingcooperative.com']
    start_urls = []
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(delta.days + 1):
            ...
            self.start_urls.append('https://writingcooperative.com/archive/'+day.strftime("%Y/%m/%d"))
