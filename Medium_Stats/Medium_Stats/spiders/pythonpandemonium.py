...
class PythonpandemomiumSpider(scrapy.Spider):
    name = 'pythonpandemonium'
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(delta.days + 1):
            ...
            self.start_urls.append('https://medium.com/python-pandemonium/archive/'+day.strftime("%Y/%m/%d"))
