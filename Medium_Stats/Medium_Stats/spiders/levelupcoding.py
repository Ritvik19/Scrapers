...
class LevelupcodingSpider(scrapy.Spider):
    name = 'levelupcoding'
    allowed_domains = ['levelup.gitconnected.com']
    start_urls = []
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(delta.days + 1):
            ...
            self.start_urls.append('https://levelup.gitconnected.com/archive/'+day.strftime("%Y/%m/%d"))
