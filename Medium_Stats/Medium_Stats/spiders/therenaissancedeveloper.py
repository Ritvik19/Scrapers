...
class TherenaissancedeveloperSpider(scrapy.Spider):
    name = 'therenaissancedeveloper'
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(delta.days + 1):
            ...
            self.start_urls.append('https://medium.com/the-renaissance-developer/archive/'+day.strftime("%Y/%m/%d"))
