...
class PythoninplainenglishSpider(scrapy.Spider):
    name = 'pythoninplainenglish'
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(delta.days + 1):
            ...
            self.start_urls.append('https://medium.com/python-in-plain-english/archive/'+day.strftime("%Y/%m/%d"))
