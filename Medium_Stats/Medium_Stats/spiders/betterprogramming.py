...
class BetterprogrammingSpider(scrapy.Spider):
    name = 'betterprogramming'
    ...
    def __init__(self, **kwargs):
        ...
        for i in range(delta.days + 1):
            ...
            self.start_urls.append('https://medium.com/better-programming/archive/'+day.strftime("%Y/%m/%d"))
